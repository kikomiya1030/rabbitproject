# Generated by Django 4.0 on 2023-11-13 05:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=200, verbose_name='アイテム')),
                ...
                ('posted_at', models.DateTimeField(auto_now_add=True, verbose_name='更新日')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='rabbitapp.category', verbose_name='カテゴリ')),
